...
public class NpcScript : IScriptV2
{
	...
	{
		string quest1 = GetQuestData(1008100);
		string quest2 = GetQuestData(1008101);
		string lastDate = GetQuestData(1008102);
