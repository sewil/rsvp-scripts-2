...
public class NpcScript : IScriptV2
{
	public override void Run()
	{
		if (Job == 400 && Level >= 30)
		{
			...
			{
				self.say("Ohhhhh... you collected all 30 #t4031013#s!! Should have been difficult... incredible. Alright. You've passed the test and for that, I'll reward you with #b#t4031012##k. Take that item and go back to #m103000000#.");
				
				int marble = ItemCount(4031013);
				
				if (!Exchange(0, 4031013, -marble, 4031011, -1, 4031012, 1))
				{
					self.say("Hmmm... something's not right... please check and see if you 30 #t4031013#s, the letter from #b#p1052001##k, and if you have an empty slot on your Etc. inventory.");
					return;
				}
			}
			else
