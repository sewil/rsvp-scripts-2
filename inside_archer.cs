...
public class NpcScript : IScriptV2
{
	public override void Run()
	{
		if (Job == 300 && Level >= 30)
		{
			...
			{
				self.say("Ohhhhh... you collected all 30 #t4031013#s!! Wasn't it difficult?? Alright. You've passed the test and for that, I'll give you #b#t4031012##k. Take that item and go back to #m100000000#.");
				
				int marble = ItemCount(4031013);
				
				if (!Exchange(0, 4031013, -marble, 4031010, -1, 4031012, 1))
				{
					self.say("Hmmm... something's not right... please check and see if you 30 #t4031013#s, the letter from #b#p1012100##k, and if you have an empty slot on your Etc. inventory.");
					return;
				}
			}
			else
