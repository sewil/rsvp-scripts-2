...
public class NpcScript : IScriptV2
{
	...
	{
		// PC100: Beginner JQ
			// 902000800: End of the Challenge <Beginner>
			// 902000900: Bonus <Beginner>
		// PC101: Advanced JQ
		if (MapID == 902001000 || MapID == 902001100 || MapID == 902011300 || MapID == 902021300)
		{
			if (AskYesNo("Ready to go back to the #bInternet Cafe#k?"))
			{
				...
				switch(MapID)
				{
					case 902001000: // Winning the Challenge <Beginner>
					case 902001100: // Challenge Exit <Beginner>
					case 902011300: ChangeMap(103000007); break; // Challenge Exit <Advanced>
					case 902021300: ChangeMap(220000309); break;
				}
			}
		}
		// Challenge complete map
		else if (MapID == 902000800 || MapID == 902011000 || MapID == 902021000)
		{
