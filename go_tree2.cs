...
public class NpcScript : IScriptV2
{
	...
	{
		int askTree = AskMenu("Hello~ I'm #p2001002#. I can take you to the room where the humongous Christmas tree is! For more information, talk to #b#p2001000##k. Which room will you enter?#b",
