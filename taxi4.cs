...
public class NpcScript : IScriptV2
{
	...
	{
		self.say("How's it going? I drive the #p1052016#. If you want to go from town to town safely and fast, then ride our cab. We'll gladly take you to your destination for an affordable price.");
		...
		if (Job == 0)
		{
			...
			switch(askStart)
			{
				...
				case 2: GoTown(100000000, 100); break;
		...
		else
		{
			...
			switch(askStart)
			{
				...
				case 2: GoTown(100000000, 1000); break;
