...
public class NpcScript : IScriptV2
{
	...
	{
		string quest1 = GetQuestData(1008200);
		string quest2 = GetQuestData(1008201);
		string lastDate = GetQuestData(1008202);
			...
			else if (quest1 == "e")
			{
				if (lastDate != today)
				{
					if (quest2 == "" || quest2 == "e")
					{
						...
						if (start2)
						{
							SetQuestData(1008201, "999");
							self.say("Once your work with your guild mates are done, make sure to report this to #r#p1061011##k!");
						}
					}
					else
					{
