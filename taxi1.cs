...
public class NpcScript : IScriptV2
{
	...
	{
		self.say("Hey, I drive the #p1022001#. If you want to go from town to town safely and fast, then ride our cab. We'll gladly take you to your destination for an affordable price.");
		...
		if (Job == 0)
		{
			int askStart = AskMenu("We have a special 90% discount for beginners. Choose your destination, for fees will change from place to place.#b",
				(0, " #m104000000# (120 mesos)"),
				(1, " #m100000000# (100 mesos)"),
				(2, " #m101000000# (100 mesos)"),
				(3, " #m103000000# (80 mesos)"));
				
			switch(askStart)
			{
				case 0: GoTown(104000000, 120); break;
				case 1: GoTown(100000000, 100); break;
				case 2: GoTown(101000000, 100); break;
				case 3: GoTown(103000000, 80); break;
			}
		}
		else
		{
			int askStart = AskMenu("Choose your destination, for fees will change from place to place.#b",
				(0, " #m104000000# (1,200 mesos)"),
				(1, " #m100000000# (1,000 mesos)"),
				(2, " #m101000000# (1,000 mesos)"),
				(3, " #m103000000# (800 mesos)"));
				
			switch(askStart)
			{
				case 0: GoTown(104000000, 1200); break;
				case 1: GoTown(100000000, 1000); break;
				case 2: GoTown(101000000, 1000); break;
				case 3: GoTown(103000000, 800); break;
			}
		}
	}
}