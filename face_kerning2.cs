...
public class NpcScript : IScriptV2
{
	...
	{
		int selectFace = AskMenu("Hey, you there! Yes, I am Dr. Niora's assistant here at the Kerning City Hosptial. If you have #b#t4052002##k or #b#t4052012##k, I'll take care of the rest.#b",
			(0, " Plastic Surgery (REG coupon)"),
			(1, " Cosmetic Lens (REG coupon)"));
			
		if (selectFace == 0)
		{
			bool askStyle = AskYesNo("If you use the regular coupon, your face may transform into something else... Still want to do this using #b#t4052002##k?");
			...
			chr.SetFace(mFace);
			self.say("Okay, the surgery's complete. Here's the mirror... What do you think? My eyes aren't the best but I think you look great, hahahaha! Please come back when you get sick of that new look.");
		}
		else if (selectFace == 1)
		{
			bool askLens = AskYesNo("If you use the regular coupon, you'll be awarded a random pair of cosmetic lenses. Are you going to use #b#t4052012##k and really make the change to your eyes?");
